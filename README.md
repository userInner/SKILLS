...
快照日期 **2026-08-22**。共收录 **1707** 个超过 300 Star 的来源，其中 **1703** 个已核验包含 `SKILL.md`。Star 会变化，排名不代表安全或质量背书。

自动发现只进入索引；许可证、依赖、权限和隔离测试通过后，才可能进入直装目录。

README 仅展示前 10 名；[查看完整 1707 项排行榜](RANKING.md)。

| 排名 | 项目 | Stars | 许可证 | SKILL.md 数 | 本仓库状态 |
|---:|---|---:|---|---:|---|
| 1 | [vinta/awesome-python](https://github.com/vinta/awesome-python) | 315,378 | 未识别 | 2 | 索引，许可证未识别 |
| 2 | [obra/superpowers](https://github.com/obra/superpowers) | 275,711 | MIT | 14 | 已精选导入 |
| 3 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 241,835 | MIT | 896 | 已精选导入 |
| 4 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 234,038 | MIT | 198 | 索引，Agent 框架耦合 |
| 5 | [mattpocock/skills](https://github.com/mattpocock/skills) | 229,807 | MIT | 35 | 已精选导入 |
| 6 | [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) | 204,923 | 未识别 | 1 | 索引，许可证未识别 |
| 7 | [ultraworkers/claw-code](https://github.com/ultraworkers/claw-code) | 195,104 | MIT | 0 | 索引，框架耦合 |
| 8 | [anthropics/skills](https://github.com/anthropics/skills) | 170,879 | 未识别 | 18 | 索引，许可证未识别 |
| 9 | [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) | 170,623 | AGPL-3.0 | 5 | 索引，待人工审查 |
| 10 | [msitarzewski/agency-agents](https://github.com/msitarzewski/agency-agents) | 147,218 | MIT | 0 | 索引 |
