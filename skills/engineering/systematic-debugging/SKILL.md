...
1. **Create Failing Test Case**
   ...
   - Use `$test-driven-development` for writing proper failing tests when that Skill is installed
...
3. **Verify Fix**
   ...
   - Use `$verification-before-completion` before claiming success when that Skill is installed
