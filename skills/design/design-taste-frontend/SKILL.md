...
**Status:** the schema is defined here. A local `blocks/` directory is optional; when it is absent, use the schema below directly instead of assuming prebuilt blocks exist. Do not freelance new blocks without following this schema.
