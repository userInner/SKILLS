...
The search script lives inside this skill's own directory, not the project directory. Resolve `<skill-directory>` to the absolute directory containing this `SKILL.md`, then invoke the script by its full path:
