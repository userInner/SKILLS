...
**Context:** If execution should be isolated, create a worktree or equivalent sandbox using the host Agent's available workflow before starting implementation.
...
> **For agentic workers:** Implement this plan task by task using the host Agent's available execution or delegation workflow. Steps use checkbox (`- [ ]`) syntax for tracking.
...
- Use the host Agent's isolated subagent mechanism
