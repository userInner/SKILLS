...
Create a comprehensive Product Requirements Document (PRD) for the product or feature described in the user's request. The document should align stakeholders and guide development.
