...
### Input
Analyze the competitive landscape for the product or company described in the user's request and the specified market or industry segment.
...
1. **Market Scoping**: Define the market, industry, and addressable customer base for the subject
...
5. **Differentiation Mapping**: Identify gaps, overlaps, and opportunities for the subject to differentiate
...
- How this competitor threatens the subject
...
- Recommended competitive positioning for the subject
